...
# Java config
ENV CATALINA_OPTS="$CATALINA_OPTS -XX:MaxRAMPercentage=85 -XX:+ExitOnOutOfMemoryError -Xdump:tool:events=throw+systhrow,filter=java/lang/OutOfMemoryError,exec='kill -TERM 1' -Xgcpolicy:gencon -Xaggressive -Xclassgc -Xalwaysclassgc -Xtune:virtualized -XX:+IdleTuningGcOnIdle -Djdk.tls.ephemeralDHKeySize=2048 -DShowLog=true -Dcalima.log.checkMemory=true -Dcalima.gc.force=true -Djava.awt.headless=true -Duser.timezone=GMT-3 -Duser.language=pt -Duser.country=BR"
